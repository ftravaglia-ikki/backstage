...
const UserSettingsPage = userSettingsPlugin.provide(
  createRoutableExtension({
    ...
    component: () => import('./esm/index-f399d158.esm.js').then((m) => m.SettingsPage),
...
const UserSettingsThemeToggle = () => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(ListItemSecondaryAction, { className: classes.listItemSecondaryAction }, /* @__PURE__ */ React.createElement(
      ...
      themeIds.map((theme) => {
        var _a;
        const themeIcon = (_a = themeIds.find((it) => it.id === theme.id)) == null ? void 0 : _a.icon;
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(React.Fragment, null, themeTitle, "\xA0", /* @__PURE__ */ React.createElement(ThemeIcon, { id: themeId, icon: themeIcon, activeId: themeId }))
        );
      }),
