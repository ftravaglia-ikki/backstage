import { createApiRef, AnalyticsContext, createReactExtension, useElementFilter, getComponentData, useAnalytics, useApi, configApiRef } from '@backstage/core-plugin-api';
import React, { useMemo, createElement, useCallback, Fragment, isValidElement, cloneElement, useContext, useState, useEffect, forwardRef, useRef } from 'react';
import { makeStyles, ListItemIcon, ListItemText, Box, List, ListItem, TextField, InputAdornment, IconButton, CircularProgress, Chip, FormControl, FormLabel, FormControlLabel, Checkbox, InputLabel, Select, MenuItem, Typography as Typography$1, TablePagination, InputBase, ListSubheader, Menu, Button as Button$1 } from '@material-ui/core';
...
const SelectFilter = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      values.map((value) => /* @__PURE__ */ React.createElement(MenuItem, { key: value, value }, /* @__PURE__ */ React.createElement(Typography$1, { variant: "inherit", noWrap: true }, value)))
    )
  );
};
