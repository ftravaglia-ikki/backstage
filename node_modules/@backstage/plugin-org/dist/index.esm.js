...
const EntityGroupProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-771be19c.esm.js').then((m) => m.GroupProfileCard)
    }
  })
);
const EntityMembersListCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-771be19c.esm.js').then((m) => m.MembersListCard)
    }
  })
);
const EntityOwnershipCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-771be19c.esm.js').then((m) => m.OwnershipCard)
    }
  })
);
const EntityUserProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-771be19c.esm.js').then((m) => m.UserProfileCard)
    }
  })
);
...
const getChildOwnershipEntityRefs = async (entity, catalogApi) => {
